...
displacement_background_opponent_and_player=function(obj1,obj2,obj3,obj4,game){
	...
	var delaydisplacement=500
		var vitesse_displacement=500

		displacement_position (game,obj1,-w,0,vitesse_displacement,"Bounce.out")
		displacement_position (game,obj2,-w,0,vitesse_displacement,"Bounce.out")
		displacement_position (game,obj3,w,0,vitesse_displacement,"Bounce.Out")
		displacement_position (game,obj4,w,0,vitesse_displacement,"Bounce.Out")
		...
		*/
		game.time.events.add(delaydisplacement,() => displacement_position(game,obj1,0,0,vitesse_displacement,"Bounce.Out"),this);
	game.time.events.add(delaydisplacement,() => displacement_position(game,obj2,0,0,vitesse_displacement,"Bounce.Out"),this);
	game.time.events.add(delaydisplacement,() => displacement_position(game,obj3,0,0,vitesse_displacement,"Bounce.Out"),this);
	game.time.events.add(delaydisplacement,() => displacement_position(game,obj4,0,0,vitesse_displacement,"Bounce.Out"),this);
...
displacement_position(game,obj1,-5000,-2*h,10000,"Linear.None")
displacement_position(game,obj2,2000,-2*h,1000,"Linear.None")
