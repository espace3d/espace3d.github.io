...
draw_background = function(game){
	...
	this.text_name_opponent.text = parameter.name_opponent[2]
...
draw_background.prototype.init_name_opponent = function(nombre) {
this.text_name_opponent.text=parameter.name_opponent[nombre]	
}
